    ...
    <div id="layout-wrapper">
        ...
        <div class="main-content">
            <div class="page-content">
                                    ...
                                    <form autocomplete="off" method="POST" action="{{ route('expence.dailyfilter') }}"
                                        ...
                                        <div style="margin-right: 10px;">
                                            <input type="date" class="form-control" name="date" id="date"
                                                placeholder="Enter Your " required value="{{ $daily_date }}">
                                        </div>
                                        <div style="margin-right: 10px;">
                                            <button type="submit"
                                        ...
                                        <a href="/pdfexportexpence/{{ $daily_date }}" class="nofilter "
                ...
                @endif
                <table class="table table-bordered dt-responsive nowrap w-100" style="background-color: #CADAF1;">
                    <thead>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <ul class="list-unstyled hstack gap-1 mb-0">
                                                        <li>
                                                            <a href="{{ route('expence.edit', ['id' => $datas->id]) }}"
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-body px-4 py-5 text-center">
                                                            ...
                                                            <p class="text-muted font-size-16 mb-4">Please confirm that you
                                                                wish to remove the expence.</p>

                                                            <div class="hstack gap-2 justify-content-center mb-0">
                                                                <form autocomplete="off" method="POST"
                                                                    action="{{ route('expence.delete', ['id' => $datas->id]) }}">
                                                                    @method('PUT')
                                                                    @csrf
