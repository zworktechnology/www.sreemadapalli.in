                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">Staff Member</h4>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <ul class="list-unstyled hstack gap-1 mb-0">
                                                    <li>
                                                        <a href="{{ route('employee.view', ['id' => $datas->id]) }}" class="btn btn-sm btn-soft-pink"><i class="mdi mdi-card-account-details-star-outline"></i></a>
                                                    </li>
                                                    <li>
                                                        <a href="{{ route('employee.edit', ['id' => $datas->id]) }}" class="btn btn-sm btn-soft-info"><i class="mdi mdi-pencil-outline"></i></a>
                                                    </li>
                                                    <li>
