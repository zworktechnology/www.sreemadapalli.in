                                ...
                                <form autocomplete="off" method="post" action="{{ route('customer.getdatewiseCustomerOrders') }}">
                                    ...
                                    <div style="display: flex;">
                                        <div style="margin-right: 10px;">
                                            <input type="date" class="form-control" name="from_date" id="from_date" placeholder="Enter Your " required value="2023-01-01">
                                        </div>
                                        <div style="margin-right: 10px;">
                                        ...
                                        <form autocomplete="off" method="POST" action="{{ route('payment.store') }}">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="row mb-2">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select class="form-control js-example-basic-single not-allowed" name="customer_id" required >
                                                            <option value="" disabled selected hidden class="text-muted">
                                                                Enter Your</option>
                                                            @foreach ($customer as $customers)
                                                            <option value="{{ $customers->id }}" @if ($customers->id === $data->id) selected='selected' @endif>{{ $customers->name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
