                                        ...
                                        <div class="row mb-3 file-1">
                                            ...
                                            <div class="col-sm-2">
                                                <input type="number" class="form-control" name="field_unit_1"
                                                    id="field_unit_1" placeholder="Unit" onchange="totalcalculate()" value="{{ $data->field_unit_1 }}">
                                            </div>
                                            <div class="col-sm-2">
                                                <input type="number" class="form-control" name="field_unit_price_1"
                                                    id="field_unit_price_1" placeholder="Price" onchange="totalcalculate()" value="{{ $data->field_unit_price_1 }}">
                                            </div>
                                            <div class="col-sm-2">
                                                <input type="number" class="form-control" name="field_total_1"
                                                    id="field_total_1" placeholder="Total" onchange="totalcalculate()" value="{{ $data->field_total_1 }}">
                                            </div>
                                        </div>
                                        <div class="row mb-3 file-2">
                                            ...
                                            <div class="col-sm-2">
                                                <input type="number" class="form-control" name="field_unit_2"
                                                    id="field_unit_2" placeholder="Unit" onchange="totalcalculate()" value="{{ $data->field_unit_2 }}">
                                            </div>
                                            <div class="col-sm-2">
                                            ...
                                            <div class="col-sm-2">
                                                <input type="number" class="form-control" name="field_total_2"
                                                    id="field_total_2" placeholder="Total" onchange="totalcalculate()" value="{{ $data->field_total_2 }}">
                                            </div>
                                        </div>
                                        <div class="row mb-3 file-3">
                                            ...
                                            <div class="col-sm-2">
                                                <input type="number" class="form-control" name="field_unit_3"
                                                    id="field_unit_3" placeholder="Unit" onchange="totalcalculate()" value="{{ $data->field_unit_3 }}">
                                            </div>
                                            <div class="col-sm-2">
                                            ...
                                            <div class="col-sm-2">
                                                <input type="number" class="form-control" name="field_total_3"
                                                    id="field_total_3" placeholder="Total" onchange="totalcalculate()" value="{{ $data->field_total_3 }}">
                                            </div>
                                        </div>
                                        <div class="row mb-3 file-4">
                                            ...
                                            <div class="col-sm-2">
                                                <input type="number" class="form-control" name="field_unit_4"
                                                    id="field_unit_4" placeholder="Unit" onchange="totalcalculate()" value="{{ $data->field_unit_4 }}">
                                            </div>
                                            <div class="col-sm-2">
                                            ...
                                            <div class="col-sm-2">
                                                <input type="number" class="form-control" name="field_total_4"
                                                    id="field_total_4" placeholder="Total" onchange="totalcalculate()" value="{{ $data->field_total_4 }}">
                                            </div>
                                        </div>
                                        <div class="row mb-3 file-5">
                                            ...
                                            <div class="col-sm-2">
                                                <input type="number" class="form-control" name="field_unit_5"
                                                    id="field_unit_5" placeholder="Unit" onchange="totalcalculate()" value="{{ $data->field_unit_5 }}">
                                            </div>
                                            <div class="col-sm-2">
                                            ...
                                            <div class="col-sm-2">
                                                <input type="number" class="form-control" name="field_total_5"
                                                    id="field_total_5" placeholder="Total" onchange="totalcalculate()" value="{{ $data->field_total_5 }}">
                                            </div>
                                        </div>
                                        <div class="row mb-3 file-6">
                                            ...
                                            <div class="col-sm-2">
                                                <input type="number" class="form-control" name="field_unit_6"
                                                    id="field_unit_6" placeholder="Unit" onchange="totalcalculate()" value="{{ $data->field_unit_6 }}">
                                            </div>
                                            <div class="col-sm-2">
                                            ...
                                            <div class="col-sm-2">
                                                <input type="number" class="form-control" name="field_total_6"
                                                    id="field_total_6" placeholder="Total" onchange="totalcalculate()" value="{{ $data->field_total_6 }}">
                                            </div>
                                        </div>
                                        <div class="row mb-3 file-6">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="number" class="form-control" name="over_all_total"
                                                    id="over_all_total" placeholder="Total" value="{{ $data->over_all_total }}">
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="row mb-3">
