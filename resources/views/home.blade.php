                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <div style="display: flex;">
                                        ...
                                        <form autocomplete="off" method="POST" action="{{ route('filterindex') }}"
                                            style="display: flex;">
                                            @method('PUT')
                                        ...
                                        @else
                                            <div>
                                                <button style="margin-right: 10px;" type="button" class="btn btn-success w-md"
                                                    data-bs-toggle="modal" data-bs-target="#staticBackdrop">Open
                                                    Account</button>
                                        ...
                                        @else
                                            <div>
                                                <button style="margin-right: 10px;" type="button" class="btn btn-success w-md"
                                                    ...
                                                    data-bs-target="#staticBackdropdeter">Denomination</button>

                                                <div class="modal fade" id="staticBackdropdeter" data-bs-backdrop="static"
                                                    data-bs-keyboard="false" tabindex="-1" role="dialog"
                                                    aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                        ...
                                        @else
                                            <div>
                                                <button type="button" class="btn btn-success w-md" data-bs-toggle="modal"
                                                    data-bs-target="#staticBackdropclose">Close Account</button>

                                                <div class="modal fade" id="staticBackdropclose" data-bs-backdrop="static"
                                                    data-bs-keyboard="false" tabindex="-1" role="dialog"
                                                    aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                            ...
                                            <table class="table align-middle table-nowrap mb-0">
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <h5 class="font-size-13 text-truncate mb-1"
                                                                style="font-weight: bold;font-size: 16px !important;">Cash on
                                                                Hand</h5>
                                                        </td>
                                                        <td style="font-weight: bold;font-size: 16px !important;">₹
                                                            {{ $totaldeterminationdate }}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <h5 class="font-size-13 text-truncate mb-1"
                                                                style="font-weight: bold;font-size: 16px !important;">Pending
                                                                Bills</h5>
                                                        </td>
                                                        <td style="font-weight: bold;font-size: 16px !important;">₹
                                                            {{ $total_pending }}</td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <h5 class="font-size-13 text-truncate mb-1"
                                                                style="font-weight: bold;font-size: 16px !important;">G Pay</h5>
                                                        </td>
                                                        <td style="font-weight: bold;font-size: 16px !important;">₹
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <h5 class="font-size-13 text-truncate mb-1"
                                                                style="font-weight: bold;font-size: 16px !important;">Phone pay
                                                            </h5>
                                                        </td>
                                                        <td style="font-weight: bold;font-size: 16px !important;">₹
                                                            {{ $phone_pay }}</td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <h5 class="font-size-13 text-truncate mb-1"
                                                                style="font-weight: bold;font-size: 16px !important;">Paytm
                                                            </h5>
                                                        </td>
                                                        <td style="font-weight: bold;font-size: 16px !important;">₹
                                                            {{ $paytm }}</td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <h5 class="font-size-13 text-truncate mb-1"
                                                                style="font-weight: bold;font-size: 16px !important;">Card</h5>
                                                        </td>
                                                        <td style="font-weight: bold;font-size: 16px !important;">₹
                                                            {{ $card }}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <h5 class="font-size-13 text-truncate mb-1"
                                                                style="font-weight: bold;font-size: 16px !important;">Other
                                                                Cash</h5>
                                                        </td>
                                                        <td style="font-weight: bold;font-size: 16px !important;">₹
                                                            {{ $payment + $other_case }}</td>
                                                    </tr>
                                                    <tr style="color: red;">
                                                        <td>
                                                            <h5 class="font-size-13 text-truncate mb-1"
                                                                style="font-weight: bold;font-size: 16px !important;">Total
                                                            </h5>
                                                        </td>
                                                        <td style="font-weight: bold;font-size: 16px !important;">₹
                                                            {{ $total_card_one }}</td>
                                ...
                                <div class="card" style="background-color: #CAF1DE;">
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="table align-middle table-nowrap mb-0">
                                                <tbody>
                                                    <tr data-bs-toggle="modal" data-bs-target="#staticBackdropopeningdetails"
                                                        class="pointer">
                                                        <td>
                                                            <h5 class="font-size-13 text-truncate mb-1"
                                                                style="font-weight: bold;font-size: 16px !important;">Opening
                                                            </h5>
                                                        </td>
                                                        <td style="font-weight: bold;font-size: 16px !important;">₹
                                                            {{ $opening }}</td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <h5 class="font-size-13 text-truncate mb-1"
                                                                style="font-weight: bold;font-size: 16px !important;">Sales
                                                            </h5>
                                                        </td>
                                                        <td style="font-weight: bold;font-size: 16px !important;">₹
                                                            {{ $sales_amount }}</td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <h5 class="font-size-13 text-truncate mb-1"
                                                                style="font-weight: bold;font-size: 16px !important;">Expense
                                                            </h5>
                                                        </td>
                                                        <td style="font-weight: bold;font-size: 16px !important;">₹
                                                            {{ $expense }}</td>
                                        ...
                                        <div class="modal fade" id="staticBackdropopeningdetails" data-bs-backdrop="static"
                                            data-bs-keyboard="false" tabindex="-1" role="dialog"
                                            aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                            @include('opening')
                                        </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table align-middle table-nowrap mb-0">
                                                <tr style="color: red;">
                                                    ...
                                                    @if ($over_all > 0)
                                                        <th scope="col"
                                                            style="font-weight: bold;font-size: 16px !important; color: green !important">
                                                            ₹ {{ $over_all }}</th>
                                                    @else
                                                        <th scope="col"
                                            ...
                                            <table class="table align-middle table-nowrap mb-0">
                                                <tbody id="current_date_denomination">
                                                    @foreach ($determination as $determinations)
                                                        <tr hidden>
                                                            ...
                                                            <td style="font-weight: bold;font-size: 16px !important;">
                                                                {{ $determinations->count_2000 }}</td>
                                                            <td style="font-weight: bold;font-size: 16px !important;">₹
                                                                {{ $determinations->total_2000 }}</td>
                                                        </tr>
                                                        <tr hidden>
                                                            <td>
                                                                <h5 class="font-size-13 text-truncate mb-1"
                                                                    style="font-weight: bold;font-size: 16px !important;">₹ 500
                                                                </h5>
                                                            </td>
                                                            <td style="font-weight: bold;font-size: 16px !important;">X</td>
                                                            <td style="font-weight: bold;font-size: 16px !important;">
                                                                {{ $determinations->count_500 }}</td>
                                                            <td style="font-weight: bold;font-size: 16px !important;">₹
                                                                {{ $determinations->total_500 }}</td>
                                                        </tr>
                                                        <tr hidden>
                                                            <td>
                                                                <h5 class="font-size-13 text-truncate mb-1"
                                                                    style="font-weight: bold;font-size: 16px !important;">₹ 200
                                                                </h5>
                                                            </td>
                                                            <td style="font-weight: bold;font-size: 16px !important;">X</td>
                                                            <td style="font-weight: bold;font-size: 16px !important;">
                                                                {{ $determinations->count_200 }}</td>
                                                            <td style="font-weight: bold;font-size: 16px !important;">₹
                                                                {{ $determinations->total_200 }}</td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <h5 class="font-size-13 text-truncate mb-1"
                                                                    style="font-weight: bold;font-size: 16px !important;">₹ 100
                                                                </h5>
                                                            </td>
                                                            <td style="font-weight: bold;font-size: 16px !important;">X</td>
                                                            <td style="font-weight: bold;font-size: 16px !important;">
                                                                {{ $determinations->count_100 }}</td>
                                                            <td style="font-weight: bold;font-size: 16px !important;">₹
                                                                {{ $determinations->total_100 }}</td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <h5 class="font-size-13 text-truncate mb-1"
                                                                    style="font-weight: bold;font-size: 16px !important;">₹ 50
                                                                </h5>
                                                            </td>
                                                            <td style="font-weight: bold;font-size: 16px !important;">X</td>
                                                            <td style="font-weight: bold;font-size: 16px !important;">
                                                                {{ $determinations->count_50 }}</td>
                                                            <td style="font-weight: bold;font-size: 16px !important;">₹
                                                                {{ $determinations->total_50 }}</td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <h5 class="font-size-13 text-truncate mb-1"
                                                                    style="font-weight: bold;font-size: 16px !important;">₹ 20
                                                                </h5>
                                                            </td>
                                                            <td style="font-weight: bold;font-size: 16px !important;">X</td>
                                                            <td style="font-weight: bold;font-size: 16px !important;">
                                                                {{ $determinations->count_20 }}</td>
                                                            <td style="font-weight: bold;font-size: 16px !important;">₹
                                                                {{ $determinations->total_20 }}</td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <h5 class="font-size-13 text-truncate mb-1"
                                                                    style="font-weight: bold;font-size: 16px !important;">₹ 10
                                                                </h5>
                                                            </td>
                                                            <td style="font-weight: bold;font-size: 16px !important;">X</td>
                                                            <td style="font-weight: bold;font-size: 16px !important;">
                                                                {{ $determinations->count_10 }}</td>
                                                            <td style="font-weight: bold;font-size: 16px !important;">₹
                                                                {{ $determinations->total_10 }}</td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <h5 class="font-size-13 text-truncate mb-1"
                                                                    style="font-weight: bold;font-size: 16px !important;">₹ 5
                                                                </h5>
                                                            </td>
                                                            <td style="font-weight: bold;font-size: 16px !important;">X</td>
                                                            <td style="font-weight: bold;font-size: 16px !important;">
                                                                {{ $determinations->count_5 }}</td>
                                                            <td style="font-weight: bold;font-size: 16px !important;">₹
                                                                {{ $determinations->total_5 }}</td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <h5 class="font-size-13 text-truncate mb-1"
                                                                    style="font-weight: bold;font-size: 16px !important;">₹ 2
                                                                </h5>
                                                            </td>
                                                            <td style="font-weight: bold;font-size: 16px !important;">X</td>
                                                            <td style="font-weight: bold;font-size: 16px !important;">
                                                                {{ $determinations->count_2 }}</td>
                                                            <td style="font-weight: bold;font-size: 16px !important;">₹
                                                                {{ $determinations->total_2 }}</td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <h5 class="font-size-13 text-truncate mb-1"
                                                                    style="font-weight: bold;font-size: 16px !important;">₹ 1
                                                                </h5>
                                                            </td>
                                                            <td style="font-weight: bold;font-size: 16px !important;">X</td>
                                                            <td style="font-weight: bold;font-size: 16px !important;">
                                                                {{ $determinations->count_1 }}</td>
                                                            <td style="font-weight: bold;font-size: 16px !important;">₹
                                                                {{ $determinations->total_1 }}</td>
                                                        </tr>
                                                        <tr style="color: red;">
                                                            <td>
                                                                <h5 class="font-size-13 text-truncate mb-1"
                                                            ...
                                                            <td style="font-weight: bold;font-size: 16px !important;"></td>
                                                            <td style="font-weight: bold;font-size: 16px !important;">₹
                                                                {{ $determinations->total_2000 + $determinations->total_500 + $determinations->total_200 + $determinations->total_100 + $determinations->total_50 + $determinations->total_20 + $determinations->total_10 + $determinations->total_5 + $determinations->total_2 + $determinations->total_1 }}
                                                            </td>
                                                        </tr>
                                                    @endforeach
                                                </tbody>
                                                ...
                                                <tbody id="filter_date_denomination" style="display:none">
                                                    <tr>
                                                        <td>
                                                            <h5 class="font-size-13 text-truncate mb-1"
                                                                style="font-weight: bold;font-size: 16px !important;">2000</h5>
                                                        </td>
                                                        <td style="font-weight: bold;font-size: 16px !important;">X</td>
                                                        <td style="font-weight: bold;font-size: 16px !important;"
                                                            class="count2000"></td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <h5 class="font-size-13 text-truncate mb-1"
                                                                style="font-weight: bold;font-size: 16px !important;">500</h5>
                                                        </td>
                                                        <td style="font-weight: bold;font-size: 16px !important;">X</td>
                                                        <td style="font-weight: bold;font-size: 16px !important;"
                                                            class="count500"></td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <h5 class="font-size-13 text-truncate mb-1"
                                                                style="font-weight: bold;font-size: 16px !important;">200</h5>
                                                        </td>
                                                        <td style="font-weight: bold;font-size: 16px !important;">X</td>
                                                        <td style="font-weight: bold;font-size: 16px !important;"
                                                            class="count200"></td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <h5 class="font-size-13 text-truncate mb-1"
                                                                style="font-weight: bold;font-size: 16px !important;">100</h5>
                                                        </td>
                                                        <td style="font-weight: bold;font-size: 16px !important;">X</td>
                                                        <td style="font-weight: bold;font-size: 16px !important;"
                                                            class="count100"></td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <h5 class="font-size-13 text-truncate mb-1"
                                                                style="font-weight: bold;font-size: 16px !important;">50</h5>
                                                        </td>
                                                        <td style="font-weight: bold;font-size: 16px !important;">X</td>
                                                        <td style="font-weight: bold;font-size: 16px !important;"
                                                            class="count50"></td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <h5 class="font-size-13 text-truncate mb-1"
                                                                style="font-weight: bold;font-size: 16px !important;">20</h5>
                                                        </td>
                                                        <td style="font-weight: bold;font-size: 16px !important;">X</td>
                                                        <td style="font-weight: bold;font-size: 16px !important;"
                                                            class="count20"></td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <h5 class="font-size-13 text-truncate mb-1"
                                                                style="font-weight: bold;font-size: 16px !important;">10</h5>
                                                        </td>
                                                        <td style="font-weight: bold;font-size: 16px !important;">X</td>
                                                        <td style="font-weight: bold;font-size: 16px !important;"
                                                            class="count10"></td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <h5 class="font-size-13 text-truncate mb-1"
                                                                style="font-weight: bold;font-size: 16px !important;">5</h5>
                                                        </td>
                                                        <td style="font-weight: bold;font-size: 16px !important;">X</td>
                                                        <td style="font-weight: bold;font-size: 16px !important;"
                                                            class="count5"></td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <h5 class="font-size-13 text-truncate mb-1"
                                                                style="font-weight: bold;font-size: 16px !important;">2</h5>
                                                        </td>
                                                        <td style="font-weight: bold;font-size: 16px !important;">X</td>
                                                        <td style="font-weight: bold;font-size: 16px !important;"
                                                            class="count2"></td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <h5 class="font-size-13 text-truncate mb-1"
                                                                style="font-weight: bold;font-size: 16px !important;">1</h5>
                                                        </td>
                                                        <td style="font-weight: bold;font-size: 16px !important;">X</td>
                                                        <td style="font-weight: bold;font-size: 16px !important;"
                                                            class="count1"></td>
